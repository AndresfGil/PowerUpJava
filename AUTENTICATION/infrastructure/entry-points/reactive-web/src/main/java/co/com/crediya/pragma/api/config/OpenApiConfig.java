    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("API de autenticación y gestión de usuarios para el sistema PowerUp. " +
                                "Para usar endpoints protegidos, primero haz login para obtener un token JWT, " +
                                "luego usa el botón 'Authorize' en la parte superior derecha para incluir el token.")
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("PowerUp Team")
